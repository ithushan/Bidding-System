    ...
    <section class="container section-t8">
        ...
        <div class="accountSection mt-5">
            <div class="sign-in sign-inD">
                <form action="backend/otpC.php" method="post">
                    <!-- Email input -->
                    <div class="form-outline mb-4">
                        <label class="form-label" for="form2Example1">Enter your OTP</label>
                        <input type="number" id="form2Example1" name="otp" class="form-control" required />
                    </div>
                    <!-- Submit button -->
